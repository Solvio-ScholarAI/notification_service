...
# Notification Service Docker Management Script
# This script provides commands to build, run, test, and manage the Docker containerized Notification Service
...
run() {
    ...
    print_success "Notification Service is running successfully!"
}
...
show_help() {
    echo "Notification Service Docker Management Script"
    echo ""
