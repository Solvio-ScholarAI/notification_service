...
# Notification Service Local Development Script
# This script provides commands to build, run, test, and manage the Spring Boot notification service
...
JAR_NAME="notification_service-0.0.1-SNAPSHOT.jar"
DEFAULT_PORT=8082
PID_FILE="notification_service.pid"
...
show_help() {
    echo "Notification Service Local Development Script"
    echo ""
